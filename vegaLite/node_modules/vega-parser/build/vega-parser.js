(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vega-util'), require('d3-format'), require('d3-time-format'), require('vega-scale'), require('vega-scenegraph'), require('d3-geo'), require('vega-dataflow'), require('vega-expression'), require('vega-statistics'), require('d3-color'), require('d3-array'), require('vega-event-selector')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vega-util', 'd3-format', 'd3-time-format', 'vega-scale', 'vega-scenegraph', 'd3-geo', 'vega-dataflow', 'vega-expression', 'vega-statistics', 'd3-color', 'd3-array', 'vega-event-selector'], factory) :
  (factory((global.vega = {}),global.vega,global.d3,global.d3,global.vega,global.vega,global.d3,global.vega,global.vega,global.vega,global.d3,global.d3,global.vega));
}(this, (function (exports,vegaUtil,d3Format,d3TimeFormat,vegaScale,vegaScenegraph,d3Geo,vegaDataflow,vegaExpression,vegaStatistics,d3Color,d3Array,vegaEventSelector) { 'use strict';
