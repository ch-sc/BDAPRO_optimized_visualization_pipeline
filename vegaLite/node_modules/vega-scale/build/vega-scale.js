(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-scale'), require('vega-util'), require('d3-interpolate'), require('d3-scale-chromatic'), require('d3-time')) :
  typeof define === 'function' && define.amd ? define(['exports', 'd3-array', 'd3-scale', 'vega-util', 'd3-interpolate', 'd3-scale-chromatic', 'd3-time'], factory) :
  (factory((global.vega = {}),global.d3,global.d3,global.vega,global.d3,global.d3,global.d3));
}(this, (function (exports,d3Array,$,vegaUtil,$$1,_,d3Time) { 'use strict';
  ...
  function binOrdinal() {
    ...
    scale.tickFormat = function() {
      var linear = $.scaleLinear().domain([domain[0], vegaUtil.peek(domain)]);
      return linear.tickFormat.apply(linear, arguments);
    };
