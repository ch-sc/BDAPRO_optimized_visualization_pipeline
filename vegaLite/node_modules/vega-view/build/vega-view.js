(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vega-util'), require('vega-dataflow'), require('vega-scenegraph'), require('d3-array'), require('vega-parser'), require('vega-runtime'), require('d3-timer')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vega-util', 'vega-dataflow', 'vega-scenegraph', 'd3-array', 'vega-parser', 'vega-runtime', 'd3-timer'], factory) :
  (factory((global.vega = {}),global.vega,global.vega,global.vega,global.d3,global.vega,global.vega,global.d3));
}(this, (function (exports,vegaUtil,vegaDataflow,vegaScenegraph,d3Array,vegaParser,vegaRuntime,d3Timer) { 'use strict';
