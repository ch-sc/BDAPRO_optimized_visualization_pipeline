...
var ThisVariable = /** @class */ (function (_super) {
    ...
    function ThisVariable(deoptimizationTracker) {
        return _super.call(this, 'this', null, null, deoptimizationTracker) || this;
    }
...
var ParameterScope = /** @class */ (function (_super) {
    ...
    function ParameterScope(parent, deoptimizationTracker) {
    ...
    ParameterScope.prototype.addParameterDeclaration = function (identifier) {
        ...
        if (name in this.hoistedBodyVarScope.variables) {
            ...
            variable = new LocalVariable(name, identifier, UNKNOWN_EXPRESSION, this.deoptimizationTracker);
        }
...
var FunctionScope = /** @class */ (function (_super) {
    ...
    function FunctionScope(parent, deoptimizationTracker) {
        var _this = _super.call(this, parent, deoptimizationTracker) || this;
...
function analyzeModuleExecution(entryModules, generateChunkColouringHashes, inlineDynamicImports, manualChunkModules) {
    var _a, _b, _c;
    var curEntry, curEntryHash;
    var cyclePaths = [];
    var allSeen = {};
    var orderedModules = [];
    var analyzedModuleCount = 0;
    var dynamicImports = [];
    ...
    return { orderedModules: orderedModules, dynamicImports: dynamicImports, dynamicImportAliases: dynamicImportAliases, cyclePaths: cyclePaths };
}
...
var Chunk$1 = /** @class */ (function () {
    ...
    Chunk.prototype.addModuleDependenciesToChunk = function (module) {
        for (var _i = 0, _a = module.dependencies; _i < _a.length; _i++) {
            var depModule = _a[_i];
    ...
    Chunk.prototype.setUpModuleImports = function (module) {
        for (var _i = 0, _a = Object.keys(module.imports); _i < _a.length; _i++) {
            var importName = _a[_i];
    ...
    Chunk.prototype.traceAndInitializeImport = function (exportName, module) {
    ...
    Chunk.prototype.generateIdPreserveModules = function (preserveModulesRelativeDir, existingNames) {
        var sanitizedId = this.entryModule.id.replace('\0', '_');
        this.id = makeUnique(normalize(isAbsolute(this.entryModule.id)
...
var Graph = /** @class */ (function () {
    ...
    Graph.prototype.build = function (entryModules, manualChunks, inlineDynamicImports, preserveModules) {
        ...
        return this.loadEntryModules(entryModules, manualChunks).then(function (_a) {
            ...
            _this.link();
            var _b = analyzeModuleExecution(entryModules, !preserveModules && !inlineDynamicImports, inlineDynamicImports, manualChunkModules), orderedModules = _b.orderedModules, dynamicImports = _b.dynamicImports, dynamicImportAliases = _b.dynamicImportAliases, cyclePaths = _b.cyclePaths;
            ...
            if (inlineDynamicImports) {
                ...
                for (var _c = 0, dynamicImports_1 = dynamicImports; _c < dynamicImports_1.length; _c++) {
                    var dynamicImportModule = dynamicImports_1[_c];
            ...
            for (var _d = 0, entryModules_1 = entryModules; _d < entryModules_1.length; _d++) {
                var entryModule = entryModules_1[_d];
            ...
            for (var _e = 0, _f = _this.externalModules; _e < _f.length; _e++) {
                var externalModule = _f[_e];
            ...
            var chunks = [];
            if (preserveModules) {
                for (var _g = 0, orderedModules_1 = orderedModules; _g < orderedModules_1.length; _g++) {
                    var module = orderedModules_1[_g];
                ...
                var chunkModules = {};
                for (var _h = 0, orderedModules_2 = orderedModules; _h < orderedModules_2.length; _h++) {
                    var module = orderedModules_2[_h];
            ...
            for (var _j = 0, chunks_1 = chunks; _j < chunks_1.length; _j++) {
                var chunk = chunks_1[_j];
                chunk.link();
            }
            // filter out empty dependencies
            chunks = chunks.filter(function (chunk) { return !chunk.isEmpty || chunk.entryModule || chunk.isManualChunk; });
            // then go over and ensure all entry chunks export their variables
            for (var _k = 0, chunks_2 = chunks; _k < chunks_2.length; _k++) {
                var chunk = chunks_2[_k];
            ...
            if (!preserveModules) {
                for (var _l = 0, entryModules_2 = entryModules; _l < entryModules_2.length; _l++) {
                    var entryModule = entryModules_2[_l];
    ...
    try {
        ...
        return graph_1.pluginDriver
            ...
            function generate(rawOutputOptions, isWrite) {
                ...
                var inputBase = commondir(chunks
                    .filter(function (chunk) { return chunk.entryModule && isAbsolute(chunk.entryModule.id); })
                    .map(function (chunk) { return chunk.entryModule.id; }));
                return graph_1.pluginDriver
